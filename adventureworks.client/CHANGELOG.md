...
- Create Angular project with ng: `ng new adventureworks.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`adventureworks.client.esproj`).
